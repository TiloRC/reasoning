...
def to_formula(expr: Any) -> object:
...
class SympyAdapter:
    def relevance_keys(self, atom: Any) -> Any:
    ...
    def add_known_facts(self, subjects: Iterable[Any], db: ClauseDB) -> None:
